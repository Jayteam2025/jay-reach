-- ============================================================================
-- Remove hardcoded Jay prod URL from crons
--
-- Context: 'kaysiemagfaqmvusyfav' (Jay prod Supabase project ref) was hardcoded
...
-- external dependency on Jay infrastructure.
-- ============================================================================
